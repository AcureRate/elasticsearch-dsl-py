...
async def test_meta_fields_can_be_accessed_directly_with_underscore():
    p = object()
...
async def test_from_es_respects_underscored_non_meta_fields():
    doc = {
        "_index": "test-index",
        "_type": "company",
        "_id": "elasticsearch",
